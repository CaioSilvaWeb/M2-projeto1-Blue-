...
btAvancar.addEventListener("click", () => {
    if(btAvancar.value == 'um'){
        imgUm.src = "assets/img/Escudo2.png";
        ...
        imgUm.src = "assets/img/Escudo5.png";
        ...
        imgUm.src = "assets/img/Escudo6.png";
        ...
        imgUm.src = "assets/img/Escudo7.png";
